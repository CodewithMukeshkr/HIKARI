...
cohere_client = cohere.Client('mpWOrbBi89Wzjgiw7aUy9lPjFKwUXptc4YfaH8IX')

# Weather API Configuration
WEATHER_API_KEY = "2782703ec264480a516215179eb7435c"
WEATHER_BASE_URL = "http://api.openweathermap.org/data/2.5/weather"

# Text-to-Speech function
def say(text):
    # Escape any double quotes in the text to prevent issues
...
# Cohere AI text generation function
        ...
        if kari:
            ...
            # weather
                ...
                if location:
                    ...
                    say(weather)  # This will now speak the weather correctly
                else:
                    say("I couldn't understand the location. Please try again.")
                do = True


            elif "exit" in kari.lower() or "quit" in kari.lower():
                say("Goodbye!")
                break

            if not do:
                # Dynamic response generation via Cohere
